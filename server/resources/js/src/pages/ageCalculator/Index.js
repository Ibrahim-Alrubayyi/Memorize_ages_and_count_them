                    ...
                    <Container className="w-md-50 pb-3">
                        <div className="landing fs-2 d-flex justify-content-center  flex-column text-center">
                            ...
                            <div className="second-text mt-2 rounded pb-1">
                                بالإضافة الى أنه يمكنك التسجيل في الموقع
                                والإحتفاظ بتاريخ ميلاد أصدقائك،
                            </div>
                            <div className="">
                                وفي حين إقترب تاريخ ميلادهم سوف تصلك رسالة تنبية
                                عبر البريد الإلكتروني المسجل في الموقع ايميل
                            </div>
                        </div>
                    </Container>
                    {/* end landing */}
